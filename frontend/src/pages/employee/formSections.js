export const formSections = {
  ...
  extra: [
    ...
    {
      name: "residence_place_apid",
      label: "محل الاقامة ( حسب الهوية)",
      type: "text",
    },
    { name: "religion", label: "المذهب", type: "text" },
    { name: "cr_mohafaza", label: "المحافظة", type: "text" },
    { name: "cr_kadaa", label: "القضاء", type: "text" },
    { name: "cr_city", label: "المدينة أو القرية", type: "text" },
    { name: "cr_7ay", label: "الحي", type: "text" },
    { name: "cr_street", label: "الشارع", type: "text" },
    ...
    {
      name: "child_number",
      label: "عدد الأولاد الذين على عاتق المستخدم",
      type: "number",
    },
  ],
  work: [
    ...
    {
      name: "other_work",
      label: "هل يعمل الأجير حسب معرفتك لدى صاحب عمل آخر",
      type: "text",
    },
    ...
    {
      name: "ow_manager_address",
      label: "عنوان صاحب العمل الآخر",
      type: "text",
    },
  ],
